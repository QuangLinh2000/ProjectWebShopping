...
@WebServlet(name = "ProductViewListController", value = "/admin-list-view-product")
public class ProductViewListController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("views/admin/page_products_list.jsp").forward(request, response);
    }
...
//        System.out.println(" satus : " + status + " loai : " + loai + " page : " + page + " date : " + date);
        ...
        List<Product> products = ProductDao.getInstance().getProductsAdmin(loai,ngayNhap,status,getStart(page,10),10);
